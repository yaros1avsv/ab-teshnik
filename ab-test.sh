...
exec claude "Бриф A/B-теста собран и сохранён в $BRIEF_JSON. Проанализируй его — прочитай файл, проверь правила, рассчитай выборку через ab_calculator.py и выведи сводку."
